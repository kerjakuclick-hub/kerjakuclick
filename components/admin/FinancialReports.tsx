...
export default function FinancialReports({
  ...
  function handleDownloadFeePlatform() {
    exportFinancialReportPdf({
      ...
      note: "Fee berjenjang (11-15% sesuai tier mitra & label Fast/PRO produk yang dikerjakan) yang dipotong dari saldo deposito mitra tiap pesanan selesai — pendapatan resmi Kerjaku.click. PDF ini memuat seluruh transaksi periode terpilih (tabel di layar hanya menampilkan 50 terbaru).",
    });
  }
      ...
      <section>
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-ink/60 mt-1">
              Fee berjenjang (11–15% sesuai tier mitra & label Fast/PRO produk, lihat Dashboard
